...
if (!defined('APP_NAME'))                       define('APP_NAME', ' uni park');
if (!defined('APP_ORGANIZATION'))               define('APP_ORGANIZATION', 'uni park');
if (!defined('APP_OWNER'))                      define('APP_OWNER', 'uni park');
if (!defined('APP_DESCRIPTION'))                define('APP_DESCRIPTION', ' uni park  ');

if (!defined('ALLOWED_INACTIVITY_TIME'))        define('ALLOWED_INACTIVITY_TIME', time() + 1 * 60);

if (!defined('DB_DATABASE'))                    define('DB_DATABASE', 'unipark');
